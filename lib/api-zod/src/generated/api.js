...
export const GetRetailerLedgerResponse = zod.array(GetRetailerLedgerResponseItem);
/**
...
export const GetUnderBuyingRetailersResponse = zod.array(GetUnderBuyingRetailersResponseItem);
/**
...
export const ListStaffPaymentsResponse = zod.array(ListStaffPaymentsResponseItem);
/**
...
export const AnalyzeStockImageResponse = zod.object({
    ...
    matchedProduct: zod
        ...
        .optional(),
    allProducts: zod.array(zod.object({
        id: zod.number(),
        articleCode: zod.string(),
        name: zod.string(),
        price: zod.number(),
...
export const AnalyzeSaleImageResponse = zod.object({
    detectedItems: zod.array(zod.object({
        articleCode: zod.string(),
        quantity: zod.number(),
        confidence: zod.number(),
        matchedProduct: zod
 ...
 */
export const ImportAirtableBody = zod.object({
    sourceIndex: zod
        .number()
        .describe("Which configured Airtable table to import (0-based)"),
    offset: zod
        .string()
        .optional()
        .describe("Airtable pagination cursor returned by the previous call"),
});
export const ImportAirtableResponse = zod.object({
    sourceIndex: zod.number(),
    imported: zod.number().describe("New products created in this page"),
    updated: zod.number().describe("Existing products updated in this page"),
    skipped: zod
        .number()
        .describe("Records skipped (missing product code) in this page"),
    nextOffset: zod
        .string()
        .nullish()
        .describe("Cursor for the next page of this source; null when source is finished"),
    totalSources: zod
        .number()
        .describe("Total number of configured Airtable sources"),
    done: zod.boolean().describe("True when this source has no more pages"),
});
/**
 * @summary Detect each footwear pair in a photo and return price-tag anchor points
 */
export const TagPricesBody = zod.object({
    imageBase64: zod
        .string()
        .describe("Base64-encoded sale photo to tag with prices"),
    items: zod.array(zod.object({
        articleCode: zod.string(),
        price: zod.number(),
...
export const TagPricesResponse = zod.object({
    tags: zod.array(zod.object({
        anchor_x: zod
            .number()
            .describe("Horizontal anchor position as a percentage (0-100) of image width"),
        anchor_y: zod
            .number()
            .describe("Vertical anchor position as a percentage (0-100) of image height"),
        side: zod.enum(["top", "bottom"]),
        articleCode: zod.string(),
        price: zod.number(),
        label: zod.string().optional(),
    })),
...
export const ListProductImagesResponse = zod.array(ListProductImagesResponseItem);
/**
...
export const GetDailySalesSummaryResponse = zod.array(GetDailySalesSummaryResponseItem);
/**
...
export const ConfirmInvoiceResponse = zod.object({
    ...
    stockUpdates: zod.array(zod.object({
        articleCode: zod.string(),
        productName: zod.string(),
...
export const GetSupplierResponse = zod.object({
    ...
    stockImages: zod.array(zod.object({
...
export const ListSupplierBillsResponse = zod.array(ListSupplierBillsResponseItem);
/**
...
export const ListPaymentClearancesResponse = zod.array(ListPaymentClearancesResponseItem);
/**
