 ...
 */
export const ListAirtableStockResponseItem = zod.object({
    articleCode: zod.string(),
    name: zod.string(),
    price: zod.number(),
    purchasePrice: zod.number().nullish(),
    ...
    localId: zod.number().nullable(),
});
export const ListAirtableStockResponse = zod.array(ListAirtableStockResponseItem);
/**
