...
import { Truck, Plus, Search, Phone, MapPin, Receipt, TrendingUp, ChevronRight, Building2 } from "lucide-react";
...
export default function Suppliers() {
  ...
  const onCreateSubmit = async (data: { name: string; phone: string; address: string; gstin: string }) => {
    try {
    ...
    <div>
      ...
      <div className="relative mb-6">
        ...
        <Input
          ...
          className="pl-10 bg-black border-white/10 text-white placeholder:text-gray-500"
        />
      </div>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-start gap-4 flex-1 min-w-0">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {supplier.gstin && (
                            <p className="text-xs text-gray-500 mt-0.5 font-mono">GSTIN: {supplier.gstin}</p>
                          )}
                        </div>
                      </div>
